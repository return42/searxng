...
class ValidateQueryCase(SearxTestCase):
    ...
    def test_without_token(self):
        preferences = Preferences(['simple'], ['general'], searx.engines.ENGINE_MAP, searx.plugins.STORAGE)
    ...
    def test_with_incorrect_token(self):
        preferences_with_tokens = Preferences(['simple'], ['general'], searx.engines.ENGINE_MAP, searx.plugins.STORAGE)
