...
def autocompleter():
    ...
    # attention: raw_text_query object is manipulated in the loop above (see
    # raw_text_query.changeQuery), if we need the origin, we have to create a
    # new one ..
    # raw_text_query = RawTextQuery(request.form.get('q', ''), disabled_engines)
...
def preferences():
    ...
    return render(
        ...
        supports = supports,
        answerers = searx.answerers.STORAGE.info(),
