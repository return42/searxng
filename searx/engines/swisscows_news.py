...
"""Regions supported by swiscows News."""
...
def request(query: str, params: "OnlineParams") -> None:
    ...
    if sxng_locale == "all":
        # news only supports very few regions (those where lang 'de' spoken)
        sxng_locale = "de"

    locale: str = appropriate_locale(sxng_locale, swisscows_regions, default="")
    if not locale:
        return
