...
def get_sc_code(engine_region, params):
    ...
    locale = babel.Locale.parse(engine_region, sep='-')
    ...
    if time() > (sc_code_ts + sc_code_cache_sec):
        logger.debug("query new sc time-stamp ... %s", base_url)
