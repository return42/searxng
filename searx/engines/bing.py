...
"""Map a SearXNG locale to a language + script that is supported by Bing."""
...
def request(query, params):
    ...
    sxng_lang = sxng_lang_script.get(sxng_locale, sxng_locale.split('-')[0])

    engine_region = traits.get_region(sxng_locale, 'en-EN')
    engine_language = traits.get_language(sxng_lang, 'en')
