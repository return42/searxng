        ...
        + urlencode(
            {
                ...
                **google_info['params'],
                ...
                # start 0   --> 'async': "arc_id:srp_10,ffilt:all,ve_name:MoreResultsContainer,next_id:srp_1,use_ac:true,inf:1,amw:true,_id:arc-srp_10,_pms:qs,_fmt:html"
                # start 20  --> 'async': "arc_id:srp_120,ffilt:all,ve_name:MoreResultsContainer,next_id:srp_1,use_ac:true,inf:1,amw:true,_id:arc-srp_120,_pms:qs,_fmt:html"
                # start 100 --> 'async': "arc_id:srp_1100,ffilt:all,ve_name:MoreResultsContainer,next_id:srp_1,use_ac:true,amw:true,_id:arc-srp_1100,_pms:qs,_fmt:html"
            }
        )
    )
        ...
        try:
            ...
            for content_feature in eval_xpath(result, content_xpath):
                ...
                if val in ['1', '2']:
                    ...
                    img_src = content_feature.xpath('.//img/@src')
                    if img_src:
                        img_src = img_src[0]
