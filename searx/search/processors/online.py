...
__all__ = ["OnlineProcessor", "OnlineRequestParams"]
...
class OnlineRequestParams(HTTPParams, RequestParams):
...
class OnlineProcessor(EngineProcessor):
    ...
    def get_params(self, search_query: SearchQuery, engine_category: str) -> OnlineRequestParams | None:
        """Returns a dictionary with the :ref:`request params <engine request
        online>` (:py:obj:`OnlineRequestParams`), if the a search condition is
        not supported by the engine, ``None`` is returned."""

        base_params: RequestParams | None = super().get_params(search_query, engine_category)
        if base_params is None:
            return base_params

        params: OnlineRequestParams = {**default_request_params(), **base_params}
    ...
    def _send_http_request(self, params: OnlineRequestParams):
    ...
    def _search_basic(self, query: str, params: OnlineRequestParams) -> "EngineResults|None":
