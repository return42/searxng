...
@t.final
class Brave(WebContainer):
    """Builds :py:obj:`WebSession` objects for the Brave engines and
    returns it.
    """

    name: ClassVar[SessionType] = "search.brave.com"
    ...
    user_agent: ClassVar[str] = "XX Ping-Pong TV App"
    ...
    def build_session_data(self, browser: "BaseWebDriver") -> WebSession | None:
        ...
        def _session_data() -> WebSession:
            ...
            session_data.HTTP_COOKIE = JS.get_cookie(browser=browser)
            try:
        ...
        browser.visit("https://search.brave.com/search?q=foobar&source=web")
        input("press [ENTER] to continue ..")
        s1 = _session_data()
        if not s1.HTTP_COOKIE:
