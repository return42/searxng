...
if t.TYPE_CHECKING:
    ...
    from searx.search.processors.online import OnlineRequestParams
...
class Engine(abc.ABC):  # pylint: disable=too-few-public-methods
    ...
    def setup(self, engine_settings: dict[str, t.Any]) -> bool:  # pyright: ignore[reportUnusedParameter]
    ...
    def init(self, engine_settings: dict[str, t.Any]) -> bool | None:  # pyright: ignore[reportUnusedParameter]
    ...
    @abc.abstractmethod
    def search(self, query: str, params: "RequestParams") -> "EngineResults":
        """Search method of the ``offline`` engines"""

    @abc.abstractmethod
    def request(self, query: str, params: "OnlineRequestParams") -> None:
